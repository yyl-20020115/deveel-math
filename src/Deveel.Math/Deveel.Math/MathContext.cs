...
public sealed class MathContext : IEquatable<MathContext>
{
    ...
    /// </summary>
    public static readonly MathContext Decimal128 = new(34, RoundingMode.HalfEven);
    ...
    /// </summary>
    public static readonly MathContext Decimal32 = new(7, RoundingMode.HalfEven);
    ...
    /// </summary>
    public static readonly MathContext Decimal64 = new(16, RoundingMode.HalfEven);

    /// <summary>
    /// A <see cref="MathContext"/> for unlimited precision with <see cref="Deveel.Math.RoundingMode.HalfUp"/> rounding.
    /// </summary>
    public static readonly MathContext Unlimited = new(0, RoundingMode.HalfUp);
    ...
    public bool Equals(MathContext other) => (other.precision == precision) &&
               (other.roundingMode == roundingMode);

    public override bool Equals(object obj) => obj is MathContext context && Equals(context);

    public override int GetHashCode() =>
        // Make place for the necessary bits to represent 8 rounding modes
        ((precision << 3) | (int)roundingMode);
    ...
    {
        var builder = new StringBuilder(45);
        builder.Append(chPrecision);
        builder.Append(precision);
        builder.Append(' ');
        builder.Append(chRoundingMode);
    ...
    public static bool TryParse(string s, out MathContext context)
        => TryParse(s, out context, out _);

    public static MathContext Parse(string s)
        => !TryParse(s, out MathContext context, out Exception error) ? throw error : context;
}