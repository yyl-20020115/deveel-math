...
{
    public static BigInteger ShiftRight(BigInteger value, int n) => (n == 0) || (value.Sign == 0)
            ? value
            : (n > 0)
    ...
    public static BigInteger ShiftLeft(BigInteger value, int n) => (n == 0) || (value.Sign == 0) ? value : (n > 0) ? BitLevel.ShiftLeft(value, n) : BitLevel.ShiftRight(value, -n);

    public static BigInteger Negate(BigInteger value) => ((value.Sign == 0) ? value : new BigInteger(-value.Sign, value.numberLength, value.digits));
    ...
    public static BigInteger Divide(BigInteger dividend, BigInteger divisor)
    {
        ...
        BigInteger result = new(resSign, resLength, resDigits);
    ...
    public static BigInteger Remainder(BigInteger dividend, BigInteger divisor)
    {
        ...
        BigInteger result = new(dividend.Sign, resLength, resDigits);
        result.CutOffLeadingZeroes();
        return result;
    }
