...
public static class Elementary
{
    ...
    public static int CompareArrays(int[] a, int[] b, int size)
    {
        int i;
    ...
    public static BigInteger Add(BigInteger op1, BigInteger op2)
    {
        ...
        BigInteger result = new(resSign, resDigits.Length, resDigits);
    ...
    internal static BigInteger Subtract(BigInteger op1, BigInteger op2)
    {
        ...
        BigInteger res = new(resSign, resDigits.Length, resDigits);
