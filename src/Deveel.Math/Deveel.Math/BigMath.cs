...
public static class BigMath
{
    ...
    public static BigInteger Add(BigInteger a, BigInteger b) => Elementary.Add(a, b);
    ...
    /// <returns>
    /// </returns>
    public static BigInteger Subtract(BigInteger a, BigInteger b) => Elementary.Subtract(a, b);
    ...
    /// </remarks>
    /// <returns></returns>
    public static BigInteger ShiftRight(BigInteger value, int n) => BigIntegerMath.ShiftRight(value, n);
    ...
    /// </remarks>
    /// <returns></returns>
    public static BigInteger ShiftLeft(BigInteger value, int n) => BigIntegerMath.ShiftLeft(value, n);
    ...
    /// </exception>
    public static BigInteger And(BigInteger a, BigInteger b) => Logical.And(a, b);

    public static BigInteger Or(BigInteger a, BigInteger b) => Logical.Or(a, b);

    public static BigInteger XOr(BigInteger a, BigInteger b) => Logical.Xor(a, b);
    ...
    /**
		 ...
		 *             if {@code val == null}.
		 */
    public static BigInteger AndNot(BigInteger value, BigInteger other) => Logical.AndNot(value, other);
...
* @return {@code ~this}.
*/
    public static BigInteger Not(BigInteger value) => Logical.Not(value);
    ...
    /// of this instance.
    /// </returns>
    public static BigInteger Negate(BigInteger value) => BigIntegerMath.Negate(value);
...
*             if {@code divisor == 0}.
*/
    public static BigInteger Divide(BigInteger dividend, BigInteger divisor) => BigIntegerMath.Divide(dividend, divisor);
...
*/
    public static BigDecimal Divide(BigDecimal a, BigDecimal b) => BigDecimalMath.Divide(a, b);
...
*/
    public static BigDecimal Divide(BigDecimal a, BigDecimal b, RoundingMode roundingMode) => !Enum.IsDefined(typeof(RoundingMode), roundingMode) ? throw new ArgumentException() : Divide(a, b, a.Scale, roundingMode);
    ...
    public static BigDecimal Divide(BigDecimal a, BigDecimal b, int scale, RoundingMode roundingMode) => BigDecimalMath.Divide(a, b, scale, roundingMode);
...
*/
    ...
    public static BigDecimal Divide(BigDecimal a, BigDecimal b, MathContext context) => BigDecimalMath.Divide(a, b, context);
...
*/
    ...
    public static BigDecimal DivideToIntegral(BigDecimal a, BigDecimal b) => BigDecimalMath.DivideToIntegralValue(a, b);
...
*/
    ...
    public static BigDecimal DivideToIntegral(BigDecimal a, BigDecimal b, MathContext context) => BigDecimalMath.DivideToIntegralValue(a, b, context);
...
*/
    ...
    public static BigDecimal DivideAndRemainder(BigDecimal a, BigDecimal b, out BigDecimal remainder) => BigDecimalMath.DivideAndRemainder(a, b, out remainder);
...
*/
    public static BigDecimal DivideAndRemainder(BigDecimal a,
        BigDecimal b,
        MathContext context,
        out BigDecimal remainder) => BigDecimalMath.DivideAndRemainder(a, b, context, out remainder);
...
*/
    ...
    public static BigDecimal Multiply(BigDecimal value, BigDecimal multiplicand) => BigDecimalMath.Multiply(value, multiplicand);
...
*/
    public static BigDecimal Pow(BigDecimal number, int exp) => BigDecimalMath.Pow(number, exp);
...
*             if {@code n < 0} or {@code n > 999999999}.
*/
    public static BigDecimal Pow(BigDecimal number, int exp, MathContext context) => BigDecimalMath.Pow(number, exp, context);
...
*/
    public static BigDecimal Abs(BigDecimal number) => (number.Sign < 0) ? -number : number;
    ...
    public static BigDecimal Abs(BigDecimal value, MathContext mc) => Abs(Round(value, mc));
    ...
    public static BigDecimal Plus(BigDecimal number) => number;
    ...
    /// </returns>
    public static BigDecimal Plus(BigDecimal number, MathContext mc) => Round(number, mc);
...
*/
    ...
    public static BigDecimal Negate(BigDecimal number) => number.BitLength < 63 || (number.BitLength == 63 && number.SmallValue != Int64.MinValue)
            ? BigDecimal.Create(-number.SmallValue, number.Scale)
            : new BigDecimal(-number.UnscaledValue, number.Scale);
    ...
    public static BigDecimal Negate(BigDecimal number, MathContext mc) => Negate(Round(number, mc));
...
*/
    ...
    public static BigDecimal Min(BigDecimal a, BigDecimal val) => ((a.CompareTo(val) <= 0) ? a : val);
    ...
    public static BigDecimal Max(BigDecimal a, BigDecimal val) => ((a.CompareTo(val) >= 0) ? a : val);
...
*/
    ...
    public static BigDecimal ScaleByPowerOfTen(BigDecimal number, int n)
    {
        ...
        return number.BitLength switch
        {
            < 64 => number.SmallValue == 0
                                ? BigDecimal.GetZeroScaledBy(newScale)
                                : BigDecimal.Create(number.SmallValue, BigDecimal.ToIntScale(newScale)),//Taking care when a 0 is to be scaled
            _ => new BigDecimal(number.UnscaledValue, BigDecimal.ToIntScale(newScale)),
        };
    }
...
*             if {@code divisor == 0}.
*/
    public static BigInteger Remainder(BigInteger dividend, BigInteger divisor) => BigIntegerMath.Remainder(dividend, divisor);
...
* @see #remainder
*/
    public static BigInteger DivideAndRemainder(BigInteger dividend, BigInteger divisor, out BigInteger remainder) => BigIntegerMath.DivideAndRemainder(dividend, divisor, out remainder);
...
*             if {@code m < 0}.
*/
    public static BigInteger Mod(BigInteger value, BigInteger m) => BigIntegerMath.Mod(value, m);
...
*             to {@code m}
*/
    public static BigInteger ModInverse(BigInteger value, BigInteger m) => BigIntegerMath.ModInverse(value, m);
...
*/
    public static BigInteger ModPow(BigInteger value, BigInteger exponent, BigInteger m) => BigIntegerMath.ModPow(value, exponent, m);
...
*             if {@code exp < 0}.
*/
    public static BigInteger Pow(BigInteger value, int exp) => BigIntegerMath.Pow(value, exp);
...
*/
    ...
    public static BigInteger Min(BigInteger a, BigInteger b) => (a.CompareTo(b) == BigInteger.LESS) ? a : b;
    ...
    /**
		 ...
		 *             if {@code val == null}
		 */
    public static BigInteger Max(BigInteger a, BigInteger b) => ((a.CompareTo(b) == BigInteger.GREATER) ? a : b);
...
*             if {@code val == null}.
*/
    public static BigInteger Gcd(BigInteger a, BigInteger b) => BigIntegerMath.Gcd(a, b);
    ...
    /// </returns>
    public static BigInteger Abs(BigInteger value) => BigIntegerMath.Abs(value);
...
*/
    ...
    public static BigDecimal Scale(BigDecimal number, int newScale, RoundingMode roundingMode) => !Enum.IsDefined(typeof(RoundingMode), roundingMode)
            ? throw new ArgumentException()
            : BigDecimalMath.Scale(number, newScale, roundingMode);
...
*/
    public static BigDecimal Scale(BigDecimal number, int newScale) => Scale(number, newScale, RoundingMode.Unnecessary);
...
*/
    ...
    public static BigDecimal MovePointLeft(BigDecimal number, int n) => BigDecimalMath.MovePoint(number, number.Scale + (long)n);
...
*/
    ...
    public static BigDecimal MovePointRight(BigDecimal number, int n) => BigDecimalMath.MovePoint(number, number.Scale - (long)n);
...
*/
    ...
    public static BigDecimal Ulp(BigDecimal value) => BigDecimal.Create(1, value.Scale);
    ...
    /// </exception>
    public static BigDecimal Add(BigDecimal value, BigDecimal augend, MathContext mc) => BigDecimalMath.Add(value, augend, mc);
    ...
    /// </exception>
    public static BigDecimal Add(BigDecimal value, BigDecimal augend) => BigDecimalMath.Add(value, augend);
    ...
    /// </exception>
    public static BigDecimal Subtract(BigDecimal value, BigDecimal subtrahend) => BigDecimalMath.Subtract(value, subtrahend);
    ...
    /// </exception>
    public static BigDecimal Subtract(BigDecimal value, BigDecimal subtrahend, MathContext mc) => BigDecimalMath.Subtract(value, subtrahend, mc);
...
*/
    ...
    public static BigDecimal StripTrailingZeros(BigDecimal value)
    {
        ...
        {
            // To divide by 10^i
            quotient = DivideAndRemainder(strippedBI, BigDecimal.TenPow[i], out BigInteger remainder);
