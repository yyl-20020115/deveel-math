...
#endif
{
    ...
    /// </summary>
    public static readonly BigInteger Zero = new(0, 0);

    /// <summary>
    /// The constant value <c>1</c> as <see cref="BigInteger"/>
    /// </summary>
    public static readonly BigInteger One = new(1, 1);

    /// <summary>
    /// The constant value <c>10</c> as <see cref="BigInteger"/>
    /// </summary>
    public static readonly BigInteger Ten = new(1, 10);

    /// <summary>
    /// The constant value <c>-1</c> as <see cref="BigInteger"/>
    /// </summary>
    internal static readonly BigInteger MinusOne = new(-1, 1);
    ...
    /// </summary>
    public bool IsOne => (numberLength == 1) && (digits[0] == 1);
    ...
    public static BigInteger Parse(string s) => Parse(s, 10);

    public static bool TryParse(string s, out BigInteger value) => TryParse(s, 10, out value);

    public static bool TryParse(string s, int radix, out BigInteger value) => TryParse(s, radix, out value, out _);

    public static BigInteger Parse(string s, int radix) => !TryParse(s, radix, out BigInteger i, out Exception error) ? throw error : i;

    #endregion

    #region Operators

    internal BigInteger ShiftLeftOneBit() => (sign == 0) ? this : BitLevel.ShiftLeftOneBit(this);


    public static BigInteger operator +(BigInteger a, BigInteger b) => BigMath.Add(a, b);

    public static BigInteger operator -(BigInteger a, BigInteger b) => BigMath.Subtract(a, b);

    public static BigInteger operator *(BigInteger a, BigInteger b) => BigMath.Multiply(a, b);

    public static BigInteger operator /(BigInteger a, BigInteger b) => BigMath.Divide(a, b);

    public static BigInteger operator %(BigInteger a, BigInteger b) => BigMath.Mod(a, b);

    public static BigInteger operator &(BigInteger a, BigInteger b) => BigMath.And(a, b);

    public static BigInteger operator |(BigInteger a, BigInteger b) => BigMath.Or(a, b);

    public static BigInteger operator ^(BigInteger a, BigInteger b) => BigMath.XOr(a, b);

    public static BigInteger operator ~(BigInteger a) => BigMath.Not(a);

    public static BigInteger operator -(BigInteger a) => BigMath.Negate(a);

    public static BigInteger operator >>(BigInteger a, int b) => BigMath.ShiftRight(a, b);

    public static BigInteger operator <<(BigInteger a, int b) => BigMath.ShiftLeft(a, b);

    public static bool operator >(BigInteger a, BigInteger b) => a.CompareTo(b) > 0;

    public static bool operator <(BigInteger a, BigInteger b) => a.CompareTo(b) < 0;

    public static bool operator ==(BigInteger a, BigInteger b) => (a is null && b is null) || (a is not null && a.Equals(b));
    ...
    public static implicit operator Int32(BigInteger i) => i.ToInt32();

    public static implicit operator Int64(BigInteger i) => i.ToInt64();

    public static implicit operator Single(BigInteger i) => i.ToSingle();

    public static implicit operator Double(BigInteger i) => i.ToDouble();

    public static implicit operator string(BigInteger i) => i.ToString();

    public static implicit operator BigInteger(int value) => FromInt64(value);

    public static implicit operator BigInteger(long value) => FromInt64(value);
 ...
 */
	 ...
	 *             if {@code n < 0}.
	 */
    public static BigInteger SetBit(BigInteger value, int n) => !TestBit(value, n) ? BitLevel.FlipBit(value, n) : value;
	 ...
	 *             if {@code n < 0}.
	 */
    public static BigInteger ClearBit(BigInteger value, int n) => TestBit(value, n) ? BitLevel.FlipBit(value, n) : value;
	 ...
	 *         otherwise.
	 */
    public static bool IsProbablePrime(BigInteger value, int certainty) => Primality.IsProbablePrime(BigMath.Abs(value), certainty);
	 ...
	 *             if {@code this < 0}.
	 */
    public static BigInteger NextProbablePrime(BigInteger value) => value.Sign switch
    {
        < 0 => throw new ArithmeticException(string.Format(Messages.math1A, value)),// math.1A=start < 0: {0}
                                                                                    //$NON-NLS-1$
        _ => Primality.NextProbablePrime(value),
    };
	 ...
	 *             if {@code bitLength < 2}.
	 */
    public static BigInteger ProbablePrime(int bitLength, Random rnd) => new BigInteger(bitLength, 100, rnd);
...
*             if {@code n < 0}.
*/
    public static BigInteger FlipBit(BigInteger value, int n) => n switch
    {
        < 0 => throw new ArithmeticException(Messages.math15),
        _ => BitLevel.FlipBit(value, n)
    };
...
*/
    ...
    public int ToInt32() => (sign * digits[0]);
    ...
    public long ToInt64()
    {
        var value = (numberLength > 1) ? (((long)digits[1]) << 32) | (digits[0] & 0xFFFFFFFFL) : (digits[0] & 0xFFFFFFFFL);
        return (sign * value);
    }
     ...
     */
    public double ToDouble() => Conversion.BigInteger2Double(this);

    public override string ToString() => Conversion.ToDecimalScaledString(this, 0);
     ...
     */
    public string ToString(int radix) => Conversion.BigInteger2String(this, radix);
