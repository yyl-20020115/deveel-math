...
#endif
{
    ...
    /// </summary>
    public static readonly BigDecimal Zero = new(0, 0);

    /// <summary>
    /// The constant one as a <see cref="BigDecimal"/>.
    /// </summary>
    public static readonly BigDecimal One = new(1, 0);
    ...
    public int CompareTo(BigDecimal val)
    {
        ...
        if (thisSign == valueSign)
        {
            ...
            else
            {
                ...
                if (diffScale < 0)
                {
                    thisUnscaled *= Multiplication.PowerOf10(-diffScale);
                }
                else if (diffScale > 0)
                {
                    valUnscaled *= Multiplication.PowerOf10(diffScale);
                }
    ...
    public override bool Equals(object obj) => ReferenceEquals(this, obj) || (obj is BigDecimal @decimal && Equals(@decimal));

    public bool Equals(BigDecimal other) 
        => ReferenceEquals(this, other)
||          other != null && other._scale == _scale
               && (_bitLength < 64
    ...
    internal void InplaceRound(MathContext mc)
    {
        ...
        BigInteger integer = BigMath.DivideAndRemainder(GetUnscaledValue(), sizeOfFraction, out BigInteger fraction);
 ...
 */
    ...
    */
    ...
    public static bool TryParse(char[] chars, int offset, int length, out BigDecimal value) => TryParse(chars, offset, length, NumberFormatInfo.InvariantInfo, out value);

    public static bool TryParse(char[] chars, int offset, int length, IFormatProvider provider, out BigDecimal value) => TryParse(chars, offset, length, null, provider, out value);

    public static bool TryParse(char[] chars, int offset, int length, MathContext context, out BigDecimal value) => TryParse(chars, offset, length, context, null, out value);
    ...
    {
        if (!DecimalString.TryParse(chars, offset, length, provider, out value, out _))
            return false;
    ...
    public static bool TryParse(char[] chars, out BigDecimal value) => TryParse(chars, (MathContext)null, out value);

    public static bool TryParse(char[] chars, MathContext context, out BigDecimal value) => TryParse(chars, context, NumberFormatInfo.InvariantInfo, out value);

    public static bool TryParse(char[] chars, IFormatProvider provider, out BigDecimal value) => TryParse(chars, null, provider, out value);
    ...
    public static BigDecimal Parse(char[] chars, int offset, int length, IFormatProvider provider) => Parse(chars, offset, length, null, provider);

    public static BigDecimal Parse(char[] chars, int offset, int length) => Parse(chars, offset, length, (MathContext)null);

    public static BigDecimal Parse(char[] chars, int offset, int length, MathContext context) => Parse(chars, offset, length, context, NumberFormatInfo.InvariantInfo);

    public static BigDecimal Parse(char[] chars, int offset, int length, MathContext context, IFormatProvider provider)
    {
        if (!DecimalString.TryParse(chars, offset, length, provider, out BigDecimal value, out Exception error))
            throw error;
    ...
    public static BigDecimal Parse(char[] chars, IFormatProvider provider) => Parse(chars, null, provider);

    public static BigDecimal Parse(char[] chars) => Parse(chars, (MathContext)null);

    public static BigDecimal Parse(char[] chars, MathContext context) => Parse(chars, context, NumberFormatInfo.InvariantInfo);

    public static BigDecimal Parse(char[] chars, MathContext context, IFormatProvider provider) => chars == null ? throw new ArgumentNullException("chars") : Parse(chars, 0, chars.Length, context, provider);
    ...
    public static bool TryParse(string s, MathContext context, IFormatProvider provider, out BigDecimal value)
    {
        ...
        if (!DecimalString.TryParse(data, 0, data.Length, provider, out value, out _))
            return false;
    ...
    public static BigDecimal Parse(string s, IFormatProvider provider) => Parse(s, null, provider);

    public static BigDecimal Parse(string s) => Parse(s, (MathContext)null);

    public static BigDecimal Parse(string s, MathContext context) => Parse(s, context, NumberFormatInfo.InvariantInfo);
    ...
    public static BigDecimal Parse(string s, MathContext context, IFormatProvider provider)
    {
        ...
        if (!DecimalString.TryParse(data, 0, data.Length, provider, out BigDecimal value, out Exception error))
            throw error;
    ...
    public static BigDecimal operator -(BigDecimal a, BigDecimal b) =>
        // In case of implicit operators apply the precision of the dividend
        BigMath.Subtract(a, b);

    public static BigDecimal operator /(BigDecimal a, BigDecimal b) =>
        // In case of implicit operators apply the precision of the dividend
        BigDecimalMath.Divide(a, b);

    public static BigDecimal operator %(BigDecimal a, BigDecimal b) =>
        // In case of implicit operators apply the precision of the dividend
        BigMath.Remainder(a, b);

    public static BigDecimal operator *(BigDecimal a, BigDecimal b) =>
        // In case of implicit operators apply the precision of the dividend
        BigMath.Multiply(a, b);

    public static BigDecimal operator +(BigDecimal a) => BigMath.Plus(a);

    public static BigDecimal operator -(BigDecimal a) => BigMath.Negate(a);

    public static bool operator ==(BigDecimal a, BigDecimal b) => (a is null && b is null) || a is not null && a.Equals(b);
    ...
    public static BigDecimal operator >>(BigDecimal a, int b) => BigMath.ShiftRight(a, b);

    public static BigDecimal operator <<(BigDecimal a, int b) => BigMath.ShiftLeft(a, b);

    #endregion

    #region Implicit Operators

    public static implicit operator short(BigDecimal d) => d.ToInt16Exact();

    public static implicit operator int(BigDecimal d) => d.ToInt32();

    public static implicit operator long(BigDecimal d) => d.ToInt64();

    public static implicit operator float(BigDecimal d) => d.ToSingle();

    public static implicit operator double(BigDecimal d) => d.ToDouble();

    public static implicit operator BigInteger(BigDecimal d) => d.ToBigInteger();
