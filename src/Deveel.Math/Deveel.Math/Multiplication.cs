...
public static class Multiplication
{
    ...
    public static BigInteger Multiply(BigInteger x, BigInteger y) => Karatsuba(x, y);
	 ...
	 * @return the top digit of production
	 */
    public static int MultiplyByInt(int[] a, int aSize, int factor) => MultiplyByInt(a, a, aSize, factor);
    ...
    public static BigInteger PowerOf10(long exp)
    {
        ...
        res *= BigMath.Pow(BigFivePows[1], intExp);
