...
public static class Division
{
    ...
    public static BigInteger[] DivideAndRemainderByInteger(BigInteger val, int divisor, int divisorSign)
    {
        ...
        BigInteger result0 = new(quotientSign,
            quotientLength,
            quotientDigits);
        BigInteger result1 = new(valSign, 1, remainderDigits);
    ...
    {
        bool result = exp >> 5 == bi.numberLength - 1
    ...
    private static BigInteger ModInverseLorencz(BigInteger a, BigInteger modulo)
    {
        ...
        BigInteger u = new(modulo.Sign,
            modulo.numberLength,
            uDigits);
        BigInteger v = new(a.Sign, a.numberLength, vDigits);

        BigInteger r = new(0, 1, new int[max + 1]); // BigInteger.ZERO;
        BigInteger s = new(1, 1, new int[max + 1]);
        s.Digits[0] = 1;
    ...
    private static BigInteger FinalSubtraction(int[] res, BigInteger modulus)
    {
        ...
        BigInteger result = new(1, modulusLen + 1, res);
    ...
    private static BigInteger ModPow2Inverse(BigInteger x, int n)
    {
        ...
        BigInteger y = new(1, new int[1 << n])
        {
            numberLength = 1
        };
        y.Digits[0] = 1;
