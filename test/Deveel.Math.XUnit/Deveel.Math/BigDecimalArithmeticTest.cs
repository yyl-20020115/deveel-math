...
public class BigDecimalArithmeticTest
{
    ...
    public void AddWithContext(string a, int aScale, string b, int bScale, string c, int cScale, int precision, RoundingMode mode)
    {
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        MathContext mc = new(precision, mode);
    ...
    public void SubtractWithContext(string a, int aScale, string b, int bScale, string c, int cScale, int precision, RoundingMode mode)
    {
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        MathContext mc = new(precision, RoundingMode.Ceiling);
    ...
    public void MultiplyWithContext(string a, int aScale, string b, int bScale, string c, int cScale, int precision, RoundingMode roundingMode)
    {
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        MathContext mc = new(precision, roundingMode);
    ...
    public void DivideBigDecimalBySevenHundred()
    {
        ...
        const int b = 700;
        BigDecimal bd1 = BigDecimal.Parse(a);
        Assert.NotNull(bd1);

        BigDecimal bd2 = new(b);
        BigDecimal result = BigMath.Divide(bd1, bd2, new MathContext(bd1.Precision));
    ...
    public void DivideExceptionRoundingMode()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        Assert.Throws<ArithmeticException>(() => BigMath.Divide(aNumber, bNumber, RoundingMode.Unnecessary));
    }
    ...
    public void DivideExceptionInvalidRoundingMode()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        Assert.Throws<ArgumentException>(() => BigMath.Divide(aNumber, bNumber, (RoundingMode)100));
    }
    ...
    public void DivideExpLessZero()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, resScale, RoundingMode.Ceiling);
        Assert.Equal(c, result.ToString());
    ...
    public void DivideRoundUpNeg()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, resScale, RoundingMode.Up);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideRoundDownNeg()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, resScale, RoundingMode.Down);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideRoundFloorPos()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, resScale, RoundingMode.Floor);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideRoundHalfUpPos()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, resScale, RoundingMode.HalfUp);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideRoundHalfDownPos()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, resScale, RoundingMode.HalfDown);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideRoundHalfEvenPos()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, resScale, RoundingMode.HalfEven);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideBigDecimal1()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideBigDecimalScaleMathContextUp()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.Divide(aNumber, bNumber, mc);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideLargeScale()
    {
        ...
        Assert.Throws<ArithmeticException>(() => BigMath.Divide(arg1, arg2, Int32.MaxValue, RoundingMode.Ceiling));
    }
    ...
    public void DivideToIntegralValue()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.DivideToIntegral(aNumber, bNumber);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideToIntegralValueMathContextUp()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal result = BigMath.DivideToIntegral(aNumber, bNumber, mc);
        Assert.Equal(c, result.ToString());
        Assert.Equal(resScale, result.Scale);
    }
    ...
    public void DivideAndRemainder1()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal quotient = BigMath.DivideAndRemainder(aNumber, bNumber, out BigDecimal remainder);
    ...
    public void DivideAndRemainderMathContextUp()
    {
        ...
        BigDecimal aNumber = new(BigInteger.Parse(a), aScale);
        BigDecimal bNumber = new(BigInteger.Parse(b), bScale);
        BigDecimal quotient = BigMath.DivideAndRemainder(aNumber, bNumber, mc, out BigDecimal remainder);
        Assert.Equal(res, quotient.ToString());
        Assert.Equal(resScale, quotient.Scale);
        Assert.Equal(rem, remainder.ToString());
        Assert.Equal(remScale, remainder.Scale);
