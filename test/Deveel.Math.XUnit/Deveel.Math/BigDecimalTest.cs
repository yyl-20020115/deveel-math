...
{
    readonly BigInteger value = BigInteger.Parse("12345908");

    readonly BigInteger value2 = BigInteger.Parse("12334560000");

    [Fact]
    public void ConstructorBigInteger()
    {
        BigDecimal big = new(value);
    ...
    {
        var big = BigDecimal.Parse("345.23499600293850");
    ...
    public void Abs()
    {
        var big = BigDecimal.Parse("-1234");
        var bigabs = BigMath.Abs(big);
    ...
    {
        var add1 = BigDecimal.Parse("23.456");
        var add2 = BigDecimal.Parse("3849.235");
        var sum = BigMath.Add(add1, add2);
        ...
        var add3 = new BigDecimal(12.34E02D);
    ...
    {
        var divd1 = new BigDecimal(value, 2);
        var divd2 = BigDecimal.Parse("2.335");
        var divd3 = BigMath.Divide(divd1, divd2, RoundingMode.Up);
    ...
    {
        var divd1 = new BigDecimal(value2, 4);
        var divd2 = BigDecimal.Parse("0.0023");
        var divd3 = BigMath.Divide(divd1, divd2, 3, RoundingMode.HalfUp);
    ...
    {
        var bigDB = new BigDecimal(-1.234E-112);
    ...
    {
        var equal1 = new BigDecimal(1.00D);
        var equal2 = BigDecimal.Parse("1.0");
    ...
    public void TestGetHashCode()
    {
        ...
        var hash = BigDecimal.Parse("1.00");
        var hash2 = new BigDecimal(1.00D);
    ...
    public void ToInt32()
    {
        var int1 = new BigDecimal(value, 3);
    ...
    public void ToInt64()
    {
        var long1 = new BigDecimal(-value2, 0);
    ...
    {
        var max1 = new BigDecimal(value2, 1);
        var max2 = new BigDecimal(value2, 4);
    ...
    {
        var min1 = new BigDecimal(-12345.4D);
        var min2 = new BigDecimal(-12345.39D);
    ...
    {
        var movePtLeft = BigDecimal.Parse("123456265.34");
        var alreadyMoved = BigMath.MovePointLeft(movePtLeft, 5);
    ...
    {
        var movePtRight = BigDecimal.Parse("-1.58796521458");
        var alreadyMoved = BigMath.MovePointRight(movePtRight, 8);
    ...
    {
        var multi1 = new BigDecimal(value, 5);
        var multi2 = new BigDecimal(2.345D);
        var result = BigMath.Multiply(multi1, multi2);
    ...
    public void Negate()
    {
        var negate1 = new BigDecimal(value2, 7);
    ...
    public void SetScaleI()
    {
        ...
        var setScale1 = new BigDecimal(value, 3);
        var setScale2 = BigMath.Scale(setScale1, 5);
    ...
    {
        var setScale1 = new BigDecimal(2.323E102);
        var setScale2 = BigMath.Scale(setScale1, 4);
        ...
        var setNeg = new BigDecimal(-value, 4);
    ...
    public void Signum()
    {
        var sign = new BigDecimal(123E-104);
    ...
    {
        var sub1 = BigDecimal.Parse("13948");
        var sub2 = BigDecimal.Parse("2839.489");
        var result = BigMath.Subtract(sub1, sub2);
        Assert.True(result.ToString().Equals("11108.511") && result.Scale == 3, "13948 - 2839.489 is wrong: " + result);
        var result2 = BigMath.Subtract(sub2, sub1);
    ...
    {
        var sub1 = BigDecimal.Parse("-29830.989");
    ...
    {
        var toString1 = BigDecimal.Parse("1234.000");
    ...
    {
        var unsVal = BigDecimal.Parse("-2839485.000");
    ...
    {
        var valueOfL = BigDecimal.Create(9223372036854775806L);
    ...
    {
        var valueOfJI = BigDecimal.Create(9223372036854775806L, 5);
    ...
    {
        var sixhundredtest = BigDecimal.Parse("600.0");
        ...
        var notrailingzerotest = BigDecimal.Parse("1");
        ...
        var zerotest = BigDecimal.Parse("0.0000");
    ...
    public void MathContextConstruction()
    {
        ...
        MathContext mcIntRm = new(precision, rm);
        MathContext mcStr = MathContext.Parse("precision=6 roundingMode=HALFDOWN");
        MathContext mcInt = new(precision);
        var res = BigMath.Abs(aNumber, mcInt);
